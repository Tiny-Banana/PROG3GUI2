...
public abstract class Crop {
    ...
    public Crop(String name, String cropType, int harvestTime, int seedCost, double experienceGain, int water,
                int waterNeeded, int waterLimit, int fertilizer, int fertilizerNeeded, int fertilizerLimit,
                boolean isWithered, int daysPlanted, int maxProduce, int basePrice) {
        this.name = name;
